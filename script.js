...
ScrollReveal().reveal(
	".home-reveal, .main-text, .faq-text, .rev-text, .about-text", {
		delay: 500,
		origin: "left"
	}
);
ScrollReveal().reveal(".faq-img, .about-img", {
	delay: 300,
	origin: "right"
});
ScrollReveal().reveal(".question, .foot-icon", {
	delay: 300,
	origin: "left",
	interval: 300,
});
ScrollReveal().reveal(".rev-box", {
	delay: 300,
	origin: "bottom",
	interval: 300,
});